...
tf.flags.DEFINE_string("test_product", "Canon G3.txt", "test product")
...
tf.flags.DEFINE_float("l2_reg_lambda", 1e-4, "L2 regularization lambda (Default: 1e-5)")
...
tf.flags.DEFINE_integer("num_epochs",20, "Number of training epochs (Default: 100)")  # 100 epochs - 11290 steps
...
tf.flags.DEFINE_float("learning_rate", 1e-8, "Which learning rate to start with. (Default: 1e-3)")
...
def train():
	# Data preprocessinng
	with tf.device('/device:GPU:0'): # Define which device to use.
    # ===============================================================
    ...
    # ===============================================================
		...
		train_d,test_d=train_test.load_pair_name(FLAGS.dir,FLAGS.pair_id_dir,FLAGS.test_product)
